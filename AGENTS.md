...
- This adapter must implement a generic `MarketDataProvider` trait/interface. This ensures the Core Commands and UI do not care *which* provider is currently supplying the market data.
